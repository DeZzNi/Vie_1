#' Assurance de vie payable au décès avec vecteur qx (Distriution uniforme par intervalle d'âge)
#'
...
ass_dis_unif_qx <- function(x=0, n=1, m=0, b=1, delta=0, qx, s=0, kappa=0){
